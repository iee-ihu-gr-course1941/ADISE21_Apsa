...
class mistigriff_game_class {
	...
	public function __construct(){
		$this->_deck = new Mistigriff_Deck($this,true);
		$this->_front = new Mistigriff_Deck($this);
	...
	public function setDeck(Mistigriff_Deck $deck){
		$deck->setOwner($this);
		$this->_deck = $deck;
	}
	...
	public function addPlayer(Mistigriff_Player $player){
		$this->_players[$player->getId()] = $player;
	}
	
	public function createPlayer(){
		$player = new Mistigriff_Player(count($this->_players));
